...
export default function MusicPlayerMock({ currentUserId, loginEmail, onLogout }) {
  ...
  async function handleConfirmCreatePlaylist(e) {
    ...
    try {
      ...
      // Create playlist in database with current user's ID
      const response = await createPlaylist(currentUserId, newPlaylistName, newPlaylistDesc, colorHex);
      ...
      // Refresh playlists from database to get accurate data
                      ...
                      <div className="card-content">
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "12px" }}>
                          {filteredArtists.map((a) => (
                            <div key={a.artist_id} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "8px", borderRadius: "8px", background: "#F8F7F3", minWidth: 0 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px", paddingBottom: "16px", borderBottom: "2px solid #E6E2D9" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <p style={{ fontSize: "12px", color: "#9ca3af", margin: "4px 0 0 0" }}>User ID: {viewingUser.user_id}</p>
